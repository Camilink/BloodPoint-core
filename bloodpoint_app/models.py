...
class campana(models.Model):
    ...
    latitud = models.DecimalField(max_digits=10, decimal_places=7, default=-33.4489, help_text="Latitud en formato decimal (ej:-33.4489)")  
    longitud = models.DecimalField(max_digits=10, decimal_places=7, default=-70.6693, help_text="Longitud en formato decimal (ej:-70.6693)")
